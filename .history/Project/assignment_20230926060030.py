...
def forward_simulation(path_to_file, total_time, num_steps):
    position_forward, position_current, velocity_current, acceleration_current = forward_simulation_speedup(path_to_file, num_steps, total_time / num_steps)
    position_forward2, position_current2, velocity_current2, acceleration_current2 = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, extend_steps, path_to_file, t_split)
