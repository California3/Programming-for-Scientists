...
def max_accurate_time(path_to_file, epsilon):
    ...
    T_cal_max = 10
    position_forward_T_max, position_current, velocity_current, acceleration_current = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, T_cal_max - 1, path_to_file, 1)
