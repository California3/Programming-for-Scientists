...
def orbit_time(path_to_file, object_name):
    ...
    epsilons = [1000, 5000, 10000, 25000, 50000, 1000000]
    for epsilon in epsilons:
        ...
        while(True):
            ...
            if not restart:
                ...
                step = step + step_by_step
            print("Iter:", iter_cnt,"Current T:", T, "Current step:", step, "Current distance:", round(distance, 2), "step_by_step:", step_by_step, "T_Step:", T_step, "epsilons:", epsilon)
