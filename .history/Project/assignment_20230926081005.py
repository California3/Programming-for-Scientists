...
def orbit_time(path_to_file, object_name):
    ...
    epsilons = [1000, 2500, 5000, 7500, 10000, 25000, 50000, 75000,1000000, 12500000, 15000000, 20000000, 25000000]
    for epsilon in epsilons:
        ...
        while(True):
            ...
            restart = False
            if step_by_step < 50:
                print("\n ",object_name,": Finish! T: ", T, "step: ", step, "step_by_step: ", step_by_step, "T_step: ", T_step, "epsilon: ", epsilon, "\n")
                return T
            if step_by_step > 40000 or iter_cnt > 100:
            ...
            if last_distance is not None:
                ...
                if last_change_in_distance is not None and last_change_in_distance > 0 and change_in_distance > last_change_in_distance:
                    step = step - step_by_step
                    step_by_step = int(step_by_step * 2)
                    step = step + step_by_step
                    restart = True
            ...
            if not restart:
                ...
                step = step + step_by_step
            print("Iter:", iter_cnt,"Current T:", T, "Current step:", step, "Current distance:", round(distance, 2), "step_by_step:", step_by_step, "epsilons:", epsilon)
