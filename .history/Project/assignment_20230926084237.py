...
def orbit_time(path_to_file, object_name):
    ...
    epsilons = [1000, 2500, 5000, 7500, 10000, 25000, 50000, 75000,1000000, 12500000, 15000000, 20000000, 25000000, 50000000, 100000000, 1000000000, 10000000000, 100000000000, 1000000000000,]
