...
def forward_simulation(path_to_file, total_time, num_steps):
    ...
    position_forward2 = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, num_steps - 1, path_to_file, total_time / num_steps, data)[0]
...
def forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, extend_steps, path_to_file, t_split, data):
    G_const = 6.67e-11
...
def max_accurate_time(path_to_file, epsilon):
    ...
    T_cal_max = 10
    position_forward_T_x, position_current, velocity_current, acceleration_current = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, T_cal_max - 1, path_to_file, 1, data)
    ...
    while(True):
        if T <= T_cal_max:
            ...
            position_forward_T_x2, position_current, velocity_current, acceleration_current = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, T  - T_cal_max, path_to_file, 1, data)
...
def orbit_time(path_to_file, object_name):
    ...
    step_max = 10
    position_forward_T_x, position_current, velocity_current, acceleration_current = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, step_max - 1, path_to_file, T_step, data)
    position_forward_T_cal = np.vstack((position_forward_T_1, position_forward_T_x))
    ...
    while(True):
        ...
        if step <= step_max:
            ...
            position_forward_T_x2, position_current, velocity_current, acceleration_current = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, step - step_max, path_to_file, T_step, data)
            position_forward_T_cal = np.vstack((position_forward_T_cal, position_forward_T_x2))
            object_position_after = position_forward_T_cal[:step, object_index*2:object_index*2+2][-1]
            step_max = step
