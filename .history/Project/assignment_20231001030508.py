...
def orbit_time(path_to_file, object_name):
    ...
    # Sequential execution is still the most stable way to get the result.
    ...
    if multi_processing_enable:
        ...
        max_current_task = 2 # define the max number of tasks running at the same time. 
        ...
        for epsilons_group in epsilons_groups:
            ...
            for future in concurrent.futures.as_completed(tasks):
                ...
                # if terminate successfully, cancel all other tasks 
                # and return the orbit time.
                if status:
