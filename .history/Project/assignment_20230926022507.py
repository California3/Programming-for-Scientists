...
def orbit_time(path_to_file, object_name):
    ...
    T_time = 1
    while True:
        position_forward_T = forward_simulation(path_to_file, T_step * T_time, T_step)[-1]
        distance = (position_forward_T[2*object_index] - object_position[0])**2 + (position_forward_T[2*object_index+1] - object_position[1])**2
