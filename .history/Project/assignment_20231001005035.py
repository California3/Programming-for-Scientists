...
def orbit_time(path_to_file, object_name):
    ...
    for epsilon in epsilons:
        ...
        step_max = 10000 
        # Add to cache, get the first 10000 steps for T_step. Num of steps is 10000. We have executed 1 step before, so we need 10000 -1  more steps.
        ...
        # Cache initialization is done. We have 10000 steps in cache now.
        position_forward_T_cal = np.vstack((position_forward_T_1, position_forward_T_x))
