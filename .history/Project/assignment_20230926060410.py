...
def forward_simulation(path_to_file, total_time, num_steps):
    ...
    position_forward2, a,b,c = forward_simulation_speedup_extend(position_current, velocity_current, acceleration_current, num_steps - 1, path_to_file, total_time / num_steps)
