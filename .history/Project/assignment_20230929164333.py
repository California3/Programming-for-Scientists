...
def get_data(path_to_file):
    # If global varialbe is allowed, we could use global varialbe to avoid reading file every time. Just read it once.
    # However, global varialbe is not allowed. So have to read file every time here. 
    # You could add global varialbe to speed up the program by modifying this function simplily.
    # Since it is not allowed, I don't do it.
