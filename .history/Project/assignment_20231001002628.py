...
def orbit_time(path_to_file, object_name):
    """
    This function calculates the time it takes for an object to complete one orbit around a celestial body.
    It takes the path to a file containing data about the celestial bodies and the name of the object as input.
    The function uses a combination of forward simulation and binary search to find the time it takes for the object to complete one orbit.
