...
def orbit_time(path_to_file, object_name):
    ...
    epsilons = [1000, 2500, 5000, 7500, 10000, 25000, 50000, 75000,1000000, 12500000, 15000000, 20000000, 25000000, 50000000]
    for epsilon in epsilons:
        ...
        while(True):
            ...
            restart = False
            if step_by_step < 25:
                print("\n \033[42m",object_name,": Finish! T: ", T, "step: ", step, "step_by_step: ", step_by_step, "T_step: ", T_step, "epsilon: ", epsilon, "\n")
                return T
